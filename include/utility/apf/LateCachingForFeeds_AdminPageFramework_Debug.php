...
class LateCachingForFeeds_AdminPageFramework_Debug_Base extends LateCachingForFeeds_AdminPageFramework_Utility {
    ...
    static protected function _getLegible($mValue) {
        ...
        $mValue = is_array($mValue) ? self::_getArrayMappedRecursive(self::_getSlicedByDepth($mValue, 20), array(__CLASS__, '_getObjectName')) : $mValue;
    ...
    static public function _getLegibleArray(array $aArray) {
        return self::_getArrayMappedRecursive(self::_getSlicedByDepth($aArray, 20), array(__CLASS__, '_getLegibleValue'));
    }
...
class LateCachingForFeeds_AdminPageFramework_Debug_Log extends LateCachingForFeeds_AdminPageFramework_Debug_Base {
    ...
    static private function _getLogHeadingLine($fCurrentTimeStamp, $nElapsed, $sCallerClass, $sCallerFunction) {
        ...
        $_aOutput = array(date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds, self::_getFormattedElapsedTime($nElapsed), self::_getPageLoadID(), '', $sCallerClass . '::' . $sCallerFunction, current_filter(), self::getCurrentURL(),);
...
class LateCachingForFeeds_AdminPageFramework_Debug extends LateCachingForFeeds_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('LateCachingForFeeds_AdminPageFramework_Debug::' . __FUNCTION__, 'LateCachingForFeeds_AdminPageFramework_Debug::dump()');
        LateCachingForFeeds_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('LateCachingForFeeds_AdminPageFramework_Debug::' . __FUNCTION__, 'LateCachingForFeeds_AdminPageFramework_Debug::get()');
        return LateCachingForFeeds_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('LateCachingForFeeds_AdminPageFramework_Debug::' . __FUNCTION__, 'LateCachingForFeeds_AdminPageFramework_Debug::log()');
        LateCachingForFeeds_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('LateCachingForFeeds_AdminPageFramework_Debug::' . __FUNCTION__);
